...
input: $(input_dir)/station_location.json $(input_dir)/Export_fixed.railml.diff $(input_dir)/dtakt-schedule.zip

$(input_dir)/station_location.json:
	wget https://stop-places.bahn.expert/2025-07-09.json -O $@
